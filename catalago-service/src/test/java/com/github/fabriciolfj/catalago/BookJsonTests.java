...
public class BookJsonTests {
    ...
    void testSerialize() throws Exception {
        var book = new Book("1234567890", "Title", "Author", Year.of(1973), BigDecimal.ZERO, null, null, 0);
    ...
    void testDeserialize() throws Exception {
        ...
        assertThat(json.parse(content)).isEqualToComparingFieldByField(new Book("1234567890", "Title", "Author", Year.of(1973), BigDecimal.ZERO, null, null, 0));
